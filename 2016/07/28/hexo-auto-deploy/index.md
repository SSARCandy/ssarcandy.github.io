...
這邊會幫你上傳 ssh\_key 到 Travis 上， `--add` 這個 flag 可以幫你插入解密指令到 `.travis.yml` 的 `before_install` 。  
...
![repository > more options 可以設定、看到 Travis 的環境變數](https://ssarcandy.tw/img/2016-07-29/2.PNG) 
