...
# Setting up OpenCV using Cmake GUI
...
![Cmake configuration](https://ssarcandy.tw/img/2016-07-23/1.png) 
...
![Right click > build](https://ssarcandy.tw/img/2016-07-23/2.png) 
...
![Add new environment variable](https://ssarcandy.tw/img/2016-07-23/3.png) 
...
![Set OPENCV\_EXTRA\_MODULES\_PATH as opencv\_contrib/modules](https://ssarcandy.tw/img/2016-07-23/4.png) 

3.  Press `configure` again, then `generate`

To see more details instructions, see [opencv\_contrib](https://github.com/Itseez/opencv_contrib#how-to-build-opencv-with-extra-modules) README
