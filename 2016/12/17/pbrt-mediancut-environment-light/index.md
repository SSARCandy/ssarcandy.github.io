...
![](https://ssarcandy.tw/img/2016-12-18/1.jpg)

![不同的環境光會讓場景中物件有不同的渲染結果<sup>\[1\]</sup>](https://ssarcandy.tw/img/2016-12-18/4.jpg) 

# Median Cut Alogrithm

直接來看一張圖:

![用 median-cut algorithm 把環境光轉成多點光源<sup>\[2\]</sup>](https://ssarcandy.tw/img/2016-12-18/2.jpg) 
...
![這張圖說明了若要獲得紅色區塊能量和，只需查表四次，計算 D-B-C+A 即可得出。](https://ssarcandy.tw/img/2016-12-18/3.jpg) 

# 結果

渲染出來的結果其實跟原本的環境光還是有些差別，畢竟是用多點光源來模擬環境光，本來就不會一模一樣。

![Median cut algorithm](https://ssarcandy.tw/img/2016-12-18/new-256-my.jpg) 

![Important sampling(original)](https://ssarcandy.tw/img/2016-12-18/new-256.jpg) 
...
-   之前 group meeting 座前面學長一直在看我的文章 [Realistic camera in pbrt](https://ssarcandy.tw/2016/11/09/pbrt-realistic-camera/ "Realistic camera in pbrt")，害我注意力都被吸走了 XD
