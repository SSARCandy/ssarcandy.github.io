...
![heightfield object and its bounding box](https://ssarcandy.tw/img/2016-10-13/1.png) 

* * *

或者是當你在算 Vertex normal 時，不知道到底算的對不對，也可以直接畫出來：

![Showing Normals on vertices](https://ssarcandy.tw/img/2016-10-13/2.png) 
...
![Bounding box 沒有正確的轉換到 object space，導致跑到怪怪的地方](https://ssarcandy.tw/img/2016-10-13/3.png) 
