...
![a 的 \_\_proto\_\_ 指向 Object](https://ssarcandy.tw/img/2017-12-06/01.PNG) 

所以其實在創造實例時，JavaScript 會把 `__proto__` 指向他的原型，以空物件 `{}` 而言，就是預設類別 `Object`。  
回到上面 Person 的例子，他的原型鍊就會是長這樣:

![man 的 sayHi 是定義在他的 \_\_proto\_\_ 中](https://ssarcandy.tw/img/2017-12-06/02.PNG) 
...
![ES6 的繼承其實也是用原型鍊串起來的。](https://ssarcandy.tw/img/2017-12-06/03.PNG) 
