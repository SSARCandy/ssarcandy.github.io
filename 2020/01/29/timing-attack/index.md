...
2.  再者，這種 Signature 加密機制都會再帶一個所謂的 nonce\[4\]，所以其實實務上也很難有辦法利用 Timing Attack。
...
2.  這個例子其實是所謂的 Order of evaluation, 跟 Early return 有一點不同。[https://en.cppreference.com/w/cpp/language/eval\_order](https://en.cppreference.com/w/cpp/language/eval_order)
...
4.  [nonce](https://en.wikipedia.org/wiki/Cryptographic_nonce) 可以有效避免重送攻擊。 (重送攻擊我常常用，可參考我的另一篇文章 [從奧客玩家視角看遊戲防禦性設計](https://ssarcandy.tw/2019/10/02/game-design-from-perspective-of-hacker/))
